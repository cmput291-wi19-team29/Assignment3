...
insert into sessions values ('SK', 'R2D2@Email');
...
insert into papers values (7, 'wordsssssssssssssssssssssssssssss', 'R', 'SK', 'R2D2@Email', 'SK');
insert into papers values (8, 'wordsssssssssssssssssssssssasdads', 'R', 'SK', 'R2D2@Email', 'SK');

insert into reviews values (1, 'Minnie@Email', 4,3,1,5);
...
insert into reviews values (7, 'Tom@Email', 4,4,4,4);
